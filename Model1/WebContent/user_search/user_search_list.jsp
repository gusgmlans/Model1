...
<html>
	...
	%>
					<tr>
						...
						<td><a href = "<%=request.getContextPath()%>/user_update/user_update_form.jsp?send_id=<%=userDto.getU_pw()%>">수정</a></td>
						<td><a href = "<%=request.getContextPath()%>/user_delete/user_delete_pro.jsp?send_id=<%=userDto.getU_pw()%>">삭제</a></td>
					</tr>
	<%
		}
	%>
